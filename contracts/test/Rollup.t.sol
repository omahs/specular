...
contract RollupTest is RollupBaseSetup {
    ...
    ///////////////////////////////////////
    // Reject First Unresolved Assertion
    ///////////////////////////////////////

    function test_rejectFirstUnresolvedAssertion_noUnresolvedAssertion(
        uint256 confirmationPeriod,
        uint256 challengePeriod,
        uint256 minimumAssertionPeriod,
        ...
        // Calling rollup.rejectFirstUnresolvedAssertion as a staker.
        vm.prank(alice);
        vm.expectRevert(IRollup.NoUnresolvedAssertion.selector);
        rollup.rejectFirstUnresolvedAssertion(alice);
    }

    function test_rejectFirstUnresolvedAssertion_challengePeriodPending(
        uint256 confirmationPeriod,
        uint256 challengePeriod
    ) public {
        // Initializing the rollup
